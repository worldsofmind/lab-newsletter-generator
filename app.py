...
st.markdown("### Select Officer or Generate for All")
officer_list = ["-- Select --"] + namelist_df["name_self"].dropna().unique().tolist()
selected_officer = st.selectbox("Select officer to generate newsletter for:", officer_list)
