...
# -- Main UI: Select officer and generate --
if ratings_file and caseload_file and namelist_file:
    try:
        ...
        officer_options = ["-- Select --"] + sorted(namelist_df["name_self"].dropna().unique())
        selected_officer = st.selectbox("Officer Name", officer_options, index=0)
